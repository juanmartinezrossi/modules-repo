...
typedef char  input_t;			//_Complex float, float, int, char, char
#define IN_TYPE			CHAR		//COMPLEXFLOAT, FLOAT, INT, CHAR, BITS
#define INPUT_MAX_DATA 		100*2048
#define NOF_INPUT_ITF		1

typedef char  output_t;			//_Complex float, float, int, char, char
#define OUT_TYPE		CHAR		//COMPLEXFLOAT, FLOAT, INT, CHAR, BITS
#define OUTPUT_MAX_DATA 	100*2048
