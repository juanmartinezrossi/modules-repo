...
#include "REAL_FILTER_interfaces.h"
#include "REAL_FILTER_functions.h"
#include "REAL_FILTER.h"

//ALOE Module Defined Parameters. Do not delete.
char mname[STR_LEN]="REAL_FILTER";
int run_times=1;
...
int initialize() {
	...
	if (block_length > get_input_max_samples()) {
		...
		moderror("Check your REAL_FILTER_interfaces.h file\n");
		return -1;
	}
	/*Include the file name and line number when printing*/
...
//	int i,k;
	...
	/* do DSP stuff here */
	functionA_COMPLEX(inp, block_length, out);
	//functionB_FLOAT(inp, block_length, out);
